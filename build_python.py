...
def install_prerequisites():
    ...
    if linux():
        if centos():
            ...
            subprocess.run(f'echo "ls -l /usr/lib64"', shell=True)
            subprocess.run(f'ls -l /usr/lib64', shell=True)
...
def install_pyenv_version(version):
    ...
    if linux():
        ...
        if centos():
            ...
            python_build_env['PYTHON_CONFIGURE_OPTS']="--enable-shared --with-tcltk-libs='-L/usr/lib64 -ltcl8.5 -ltk8.5'"
