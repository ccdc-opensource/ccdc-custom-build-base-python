...
def install_pyenv_version(version):
    ...
    if linux():
        ...
        if centos():
            ...
            python_build_env['LDFLAGS'] = subprocess.check_output(["pkg-config", "--libs", "openssl11"]).decode().strip() + f' -L{python_version_destdir()}/lib -lsqlite3'
            ...
            python_build_env['PYTHON_CONFIGURE_OPTS']=f"--enable-shared CPPFLAGS=\"-I{python_version_destdir()}/include\" LDFLAGS=\"-L{python_version_destdir()}/lib\""
