...
def install_prerequisites():
    ...
    if linux():
        if centos():
            ...
            #SqlitePackage().build()
            subprocess.run(f'echo "ls -l /usr/include"', shell=True)
            subprocess.run(f'ls -l /usr/include', shell=True)
            subprocess.run(f'echo "ls -l /usr/local/include"', shell=True)
            subprocess.run(f'ls -l /usr/local/include', shell=True)
            subprocess.run(f'echo "ls -l /usr/lib"', shell=True)
            subprocess.run(f'ls -l /usr/lib', shell=True)
            subprocess.run(f'echo "ls -l /usr/local/lib"', shell=True)
            subprocess.run(f'ls -l /usr/local/lib', shell=True)
